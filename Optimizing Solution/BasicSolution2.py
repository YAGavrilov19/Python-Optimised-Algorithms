...
def find_prime_numbers(binary_string, limit):
    """
    ...
    Returns:
        list: List of unique prime numbers found
    """
    ...
    for start in range(length):
        for end in range(start + 1, length + 1):
            ...
            # Skip strings starting with '0' unless it's just '0'
            ...
            if decimal_value < limit and is_prime(decimal_value) and decimal_value not in primes:
...
def process_input(input_str):
    ...
    try:
        ...
        primes = find_prime_numbers(binary_string, limit)
...
def main():
    ...
    # while True:
    #     user_input = input("Enter the binary string and limit (e.g., '0110,5') or 'q' to quit: ")
